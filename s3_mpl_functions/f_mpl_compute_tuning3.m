function data = f_mpl_compute_tuning3(data, ops)
...
for n_dset = 1:num_dset
    ...
    dset_params.cond_name = data.area{n_dset};
    dset_params.n_dset = n_dset;
    dset_params.trial_window_t = data.trial_window{n_dset}.trial_window_t;
    dset_params.onset_window_frames = data.trial_window{n_dset}.onset_window_frames;
    dset_params.offset_window_frames = data.trial_window{n_dset}.offset_window_frames;
