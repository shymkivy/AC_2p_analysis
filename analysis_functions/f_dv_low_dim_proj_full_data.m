...
dist_metric = params.distance_method;
...
[sel_cells, ~, resp_vals2, ~, resp_cells] = f_dv_get_resp_vals_cells(stats1, tn_all, params);
...
title_tag2 = sprintf('%s; resp %s; %d cells', title_tag1, params.responsive_cells_select, num_cells);
...
for n_cell = 1:num_cells
    if resp_type2(n_cell)
        color1 = ops.context_types_all_colors2{tn_all(resp_type2(n_cell))};
    else
        color1 = [.6 .6 .6];
    end
