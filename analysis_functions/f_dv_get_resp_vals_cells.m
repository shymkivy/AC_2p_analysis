function [selected_cells, resp_vals, resp_vals_full, resp_locs, resp_cells] = f_dv_get_resp_vals_cells(stats, tn_all, params)

feature_type = params.responsive_cells_type;
resp_cell_select = params.responsive_cells_select;
resp_thr = params.responsive_thresh;
