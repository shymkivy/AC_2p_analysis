...
ddata = app.ddata;
freq_resp_fig = app.gui_plots.freq_resp_fig;
...
stats1 = app.ddata.stats{params.planes};

params.responsive_cells_select = 'resp split';
tn_all = 1:10;
[resp_cells, ~, resp_vals, loc1] = f_dv_get_resp_vals_cells(stats1, tn_all, params);
...
if params.new_plots
    ...
    if isgraphics(freq_resp_fig)
        figure(freq_resp_fig);
        clf(freq_resp_fig);
    else
        app.gui_plots.freq_resp_fig = figure;
    end
