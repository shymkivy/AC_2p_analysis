...
% get mean values around the peaks in traces
% cell/trial x time
...
if peak_size > 1
    ...
    for n_cell = 1:num_cells
        [~, peak_loc(n_cell)] = max(trial_data_sort(n_cell,:));
        ...
        peak_val(n_cell) = mean(trial_data_sort(n_cell,pk_l2:pk_r2));
    end
else
    [peak_val, peak_loc] = max(trial_data_sort,[],2);
end
