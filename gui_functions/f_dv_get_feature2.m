function [features, resp_cells, area_labels] = f_dv_get_feature2(app, feature, data, tn_all, n_pl)
...
for n_dset = 1:num_dsets
    ...
    % get area labels
    area_labels{n_dset,1} = f_dv_get_area_label(app, data(n_dset,:));
    for n_tn = 1:num_tn
        tn1 = tn_all(n_tn);
