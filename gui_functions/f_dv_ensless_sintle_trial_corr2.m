...
for n_dset = 1:num_dsets
    ...
    [~, resp_cells] = f_dv_get_resp_vals_cells(stats1, tn_all, app.ResposivecellstypeDropDown.Value, app.ResponsivecellsselectDropDown.Value, app.RespthreshEditField.Value);
