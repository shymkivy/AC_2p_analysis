...
[featuresX, resp_cellsX] = f_dv_get_feature(app, app.xvarDropDown.Value, data, tn_all, n_pl);
[featuresY, resp_cellsY] = f_dv_get_feature(app, app.yvarDropDown.Value, data, tn_all, n_pl);
