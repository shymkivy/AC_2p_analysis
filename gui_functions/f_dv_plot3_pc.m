function f_dv_plot3_pc(data_in, tn_all, pcs, title_tag, color_cell, add_shadow, plot_idx, shadow_axis_locs)
...
shadow_alpha = 0.2;
shadow_line_width = 1;
shadow_lim_offset = 1.7; %1.7, 1.5
non_shadow_lim_offset = 1.4; %1.4 1.3
...
f1 = figure(render='painters'); hold on
...
if add_shadow
    xyzlims = [f1.Children(1).XLim(shadow_axis_locs(1)), f1.Children(1).YLim(shadow_axis_locs(2)), f1.Children(1).ZLim(shadow_axis_locs(3))]*shadow_lim_offset;
    xyzlims2 = [f1.Children(1).XLim(3-shadow_axis_locs(1)), f1.Children(1).YLim(3-shadow_axis_locs(2)), f1.Children(1).ZLim(3-shadow_axis_locs(3))]*non_shadow_lim_offset;
    ...
    f1.Children(1).XLim(shadow_axis_locs(1)) = xyzlims(1);
    f1.Children(1).YLim(shadow_axis_locs(2)) = xyzlims(2);
    f1.Children(1).ZLim(shadow_axis_locs(3)) = xyzlims(3);

    f1.Children(1).XLim(3-shadow_axis_locs(1)) = xyzlims2(1);
    f1.Children(1).YLim(3-shadow_axis_locs(2)) = xyzlims2(2);
    f1.Children(1).ZLim(3-shadow_axis_locs(3)) = xyzlims2(3);
