function [smooth_dfdt_data sig_std] = f_smooth_dfdt3(data, params)
...
if isfield(params, 'kernel_window_frames')
    kernel_window_frames = params.kernel_window_frames;
else
